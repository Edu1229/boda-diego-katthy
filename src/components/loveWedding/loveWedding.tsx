...
import pareja5 from "../../assets/img/imagen_5.jpeg";
			...
			<div className="relative w-full flex justify-center px-4 sm:px-10 md:px-16">
				<motion.div
					...
					style={{
						...
						aspectRatio: "3 / 4",
						boxShadow:
							"0 8px 40px rgba(46,109,138,0.18), 0 2px 12px rgba(46,109,138,0.10)",
				...
				>
					...
					<div
						...
						style={{
							background:
								"linear-gradient(to bottom, rgba(238,247,251,0.85) 0%, transparent 100%)",
						}}
					/>
					...
					<div
						...
						style={{
							background:
								"linear-gradient(to top, rgba(238,247,251,0.88) 0%, transparent 100%)",
						}}
					/>
