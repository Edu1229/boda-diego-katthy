...
import mono from "../../assets/img/moño.png";
...
const DressCode: React.FC = () => {
	...
	return (
		...
		>
			...
			{/* Titulo */}
			<motion.h4
				className="font-serif uppercase tracking-widest text-[#2E6D8A] mb-2 relative z-10"
			...
			{/* Subtitulo */}
			<motion.p
				className="text-lg text-[#4A7A8F] mb-8 relative z-10"
			...
			{/* Restricciones */}
			<motion.div
				className="relative z-10 max-w-sm bg-white/80 rounded-2xl shadow-md p-6 border border-[#B8DDEF]"
