...
const WeddingDate: React.FC = () => {
	...
	return (
		<section className="relative w-full bg-white py-16 px-6 overflow-hidden flex flex-col items-center text-center">
			...
			{/* ✨ Texto superior */}
			<motion.p
				className="uppercase text-xs text-gray-600 tracking-widest mb-3"
			...
			{/* 💍 Caja de fecha */}
			<motion.div
				className="mb-5 border-[#7A695D] border-y py-3 px-6 text-center bg-white/70 backdrop-blur-sm rounded-lg shadow-sm"
