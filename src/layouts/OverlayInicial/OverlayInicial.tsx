...
const OverlayInicial: React.FC<Props> = ({onEnter, audioRef}) => {
	...
	return (
		<motion.div
			...
			style={{
				background:
					"linear-gradient(160deg, #D6EEF8 0%, #EEF7FB 50%, #C8E8F5 100%)",
			}}
		>
			{/* Carta / Sobre */}
			<motion.div
			...
			>
				...
				<div className="relative w-full" style={{zIndex: 2}}>
					<svg
						...
						style={{
							filter: "drop-shadow(0 -2px 6px rgba(46,109,138,0.10))",
						}}
					>
				...
				<div
					...
					style={{
						...
						paddingRight: "28px",
						boxShadow:
							"0 8px 40px rgba(46,109,138,0.14), 0 2px 10px rgba(46,109,138,0.08)",
					}}
				>
					...
					<div
						...
						style={{
							height: "6px",
							background:
								"linear-gradient(90deg, transparent, #8EC8E0 40%, #6BAFC9 60%, transparent)",
							opacity: 0.5,
						}}
					/>
					...
					<motion.button
						...
						whileHover={{
							scale: 1.05,
							boxShadow: "0 6px 22px rgba(46,109,138,0.30)",
						}}
						whileTap={{scale: 0.96}}
